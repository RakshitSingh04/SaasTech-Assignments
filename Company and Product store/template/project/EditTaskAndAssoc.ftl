  ...
  <div class="screenlet-body">
    ...
    <#else>
      ...
      <form name="addTaskAndAssocForm" method="get" action="<@ofbizUrl>createTaskAndAssoc</@ofbizUrl>">
        ...
        <tr>
          <td width="20%">
            ${uiLabelMap.CompanyStoreTaskDetails}
          </td>
        </tr>
        <tr>
          <td class="label" >${uiLabelMap.CompanyStoreQuickAssignPartyId}</td>
          <td>
        ...
        <tr>
          <#if task??>
            <td class="label" >${uiLabelMap.CompanyStoreWorkEffortId}</td>
        ...
        <tr>
          <td class="label">${uiLabelMap.CompanyStoreWorkEffortScopeEnumId}</td>
          <td>
        ...
        <tr>
         ...
         <tr>
           ...
           <td>
             <#if task??>
               <@htmlTemplate.renderDateTimeField name="estimatedCompletionDate" className="" event="" action="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" value="${task.estimatedCompletionDate!}" size="25" maxlength="30" id="estimatedCompletionDate1" isDateType=true shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
             <#else>
         ...
         <tr>
           ...
           <td>
             ...
             <#if task??>
               <@htmlTemplate.renderDateTimeField name="actualStartDate" event="" action="" className="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" value="${task.actualStartDate!}" size="25" maxlength="30" id="actualStartDate1" isDateType=true shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
             <#else>
